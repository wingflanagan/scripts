...
Just copy the following in your preferred text editor. We also have a section in the [tools page](../../software/tools/) listing some text editor's SFZ syntax highlighting add-ons. Fill in the blanks and save as an SFZ:
...
This site is open source. [Improve this page](https://github.com/sfz/sfz.github.io/edit/source/docs/tutorials/basic_sfz_file.md)
