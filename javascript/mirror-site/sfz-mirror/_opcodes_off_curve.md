...
When [off\_mode](_opcodes_off_mode.md) is set to time, this specifies the math to be used to fade out the regions being muted by voice-stealing.

*   \-2 is a static, non-changing envelope segment.
*   \-1 is linear slope.
*   0 is x^n with n being the coefficient set in off\_shape.
*   1 is n^x.
...
This site is open source. [Improve this page](https://github.com/sfz/sfz.github.io/edit/source/docs/opcodes/off_curve.md)
