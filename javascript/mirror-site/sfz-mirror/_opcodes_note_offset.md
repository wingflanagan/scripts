...
This opcode tells SFZ to shift all incoming MIDI data by the specified number of notes - basically like octave\_offset but measured in half-steps instead of octaves. It should be used under the ‹[control](../../headers/control/)› header.
...
This site is open source. [Improve this page](https://github.com/sfz/sfz.github.io/edit/source/docs/opcodes/note_offset.md)
