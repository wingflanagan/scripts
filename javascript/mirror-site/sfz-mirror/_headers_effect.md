...
In [SFZ v1](../../opcodes/?v=1) only [effect1](../../opcodes/effect1/) and [effect2](../../opcodes/effect2/) opcodes was available and only at [‹region›](../region/) level.

From [SFZ v2](../../opcodes/?v=2) this header was added together with the addition of [effect3](../../opcodes/effect3/) and [effect4](../../opcodes/effect4/) opcodes also to modulate the related bus. Other opcodes listed in the book are [bus](../../opcodes/bus/), [type](../../opcodes/type/) and [dsp\_order](../../opcodes/dsp_order/).

The specifics of what can be used under this header differ widely between SFZ players. The information on available effects and how to control them in ARIA and Cakewalk products can be found on the [type](../../opcodes/type/) page.
...
This site is open source. [Improve this page](https://github.com/sfz/sfz.github.io/edit/source/docs/headers/effect.md)
